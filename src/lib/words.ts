...
export const getIndex = () => {
  return parseInt(String(Math.random() * WORDS.length));
};
...
export const getWordOfDay = (index: number) => {
  ...
  return localeAwareUpperCase(WORDS[index]);
};
...
export const { solution, solutionGameDate, solutionIndex, tomorrow } = getSolution(getGameDate());
