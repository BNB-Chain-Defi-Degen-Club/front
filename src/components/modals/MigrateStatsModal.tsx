...
export const MigrateStatsModal = ({ isOpen, handleClose }: Props) => {
  ...
  return (
    <BaseModal title="Transfer your statistics" isOpen={isOpen} handleClose={handleClose}>
      ...
      <div className="w-full columns-3 gap-0">
        <div className="mb-4 flex items-center">
          <p className="mb-0 flex text-sm font-medium text-gray-900 dark:text-gray-300">This is my:</p>
        </div>
        <div className="mb-4 flex items-center">
          <input
