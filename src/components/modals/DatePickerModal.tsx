...
export const DatePickerModal = ({ isOpen, initialDate, handleSelectDate, handleClose }: Props) => {
  ...
  return (
    <BaseModal title={DATEPICKER_TITLE} isOpen={isOpen} handleClose={handleClose}>
