export const GAME_TITLE = 'BNB Wordle';
export const TEAM = 'BDDC';
...
export const CORRECT_WORD_MESSAGE = (solution: string) => 'You lost 😥';
...
export const BNB_PAID_SUCCESSFULLY = 'Paid BNB successfully.';
export const ENTER_ENGLISH_ONLY = 'Enter English only.';
