...
export const CAKE_CONTRACT_ADDRESS = isDevelopment()
  ...
  : '0xFa60D973F7642B748046464e165A65B7323b0DEE';
export const DLP_CONTRACT_ADDRESS = isDevelopment()
  ? '0x3178cb505b7850e8CF4592caA11B0c9079cbA65F'
  : '0x3178cb505b7850e8CF4592caA11B0c9079cbA65F';
export const DDC_CONTRACT_ADDRESS = isDevelopment()
  ? '0x0f1C54a96DF73C9f4369B1156c3aCD5a2933C137'
  : '0x0f1C54a96DF73C9f4369B1156c3aCD5a2933C137';
